...
#ifndef lint
static char rcsid[] UTIL_UNUSED = "$Id: ntr.c,v 1.1 2001/10/29 13:40:06 none Exp $";
#endif
...
int
Ntr_buildDDs(
  BnetNetwork * net /* network foe which DDs are to be built */,
  ...
  NtrOptions *option)
{
    ...
    ** variables that are closer to being essential. */
    ...
    /* Quantify out of states varibles that no longer appear in any part. */
    Cudd_RecursiveDeref(dd,*states);
