/**CHeaderFile*****************************************************************
  ...
  Revision    [$Id: cudd.h,v 1.1.4.2 2004/05/04 09:18:28 nusmv Exp $]
...
/* NuSMV: removed end */
/* NuSMV: added begin */
#define CUDD_VALUE_TYPE		node_ptr /* The node type for dd leaves */
/* NuSMV: added end */
...
/* NuSMV: added begin */
EXTERN DdNode * Cudd_addCubeDiff ARGS((DdManager *dd, DdNode *a, DdNode *b));
EXTERN DdNode * Cudd_bddCubeDiff ARGS((DdManager *dd, DdNode *a, DdNode *b));
EXTERN int Cudd_BddGetLowestVar ARGS((DdManager *dd, DdNode * N));
EXTERN CUDD_VALUE_TYPE Cudd_add_value ARGS((DdNode * a));
EXTERN void Cudd_addWalkLeaves ARGS((void (*op)(CUDD_VALUE_TYPE), DdNode * f));
EXTERN DdNode * Cudd_addAnd ARGS((DdManager *dd, DdNode *a, DdNode *b));
EXTERN DdNode * Cudd_addNot ARGS((DdManager *dd, DdNode *a));
EXTERN DdNode * Cudd_addIfThen ARGS((DdManager *dd, DdNode *I, DdNode *T));
EXTERN DdNode * Cudd_bddPickOneMintermNR ARGS((DdManager *dd, DdNode *fn, DdNode **vars, int n));
EXTERN int Cudd_PickAllTerms ARGS((DdManager *dd, DdNode *minterm, DdNode **vars, int n, DdNode **result));
/* NuSMV: added end */
...
/* NuSMV: remove end */
/* NuSMV: add begin */
EXTERN DdNode * Cudd_addApply ARGS((DdManager *dd, CUDD_VALUE_TYPE (*op)(), DdNode *f, DdNode *g));
EXTERN DdNode * Cudd_addAbstract ARGS((DdManager *dd, CUDD_VALUE_TYPE (*op)(), DdNode *f, DdNode *cube));
/* NuSMV: add end */
