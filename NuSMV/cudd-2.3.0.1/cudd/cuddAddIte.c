...
#ifndef lint
static char rcsid[] DD_UNUSED = "$Id: cuddAddIte.c,v 1.1 2001/10/29 13:40:05 none Exp $";
#endif
...
/*---------------------------------------------------------------------------*/
/* NuSMV: added begin */
static CUDD_VALUE_TYPE Cudd_type_error ARGS((CUDD_VALUE_TYPE));
/* NuSMV: added end */
  ...
  DdNode * h)
{
    ...
    if (cuddIsConstant(f)) Cudd_type_error(cuddV(f));
    /* NuSMV: added end */
