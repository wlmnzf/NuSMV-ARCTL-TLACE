/**CHeaderFile*****************************************************************
  ...
  Revision    [$Id: cuddInt.h,v 1.1 2001/10/29 13:40:05 none Exp $]
...
/* NuSMV: added begin */
EXTERN DdNode * cudd_addApplyRecur ARGS((DdManager *dd, CUDD_VALUE_TYPE (*op)(), DdNode *f, DdNode *g));
EXTERN DdNode * cudd_addAndRecur ARGS((DdManager *manager, DdNode *f, DdNode *g));
EXTERN DdNode * cudd_addOrRecur ARGS((DdManager *manager, DdNode *f, DdNode *g));
EXTERN DdNode * cudd_addXorRecur ARGS((DdManager *manager, DdNode *f, DdNode *g));
EXTERN DdNode * cudd_addNotRecur ARGS((DdManager *manager, DdNode *f));
EXTERN DdNode * cudd_addIfThenRecur ARGS((DdManager *manager, DdNode *f, DdNode *g));
EXTERN DdNode * cudd_addElseRecur ARGS((DdManager *manager, DdNode *f, DdNode *g));
EXTERN DdNode * cudd_addCubeDiffRecur ARGS((DdManager *dd, DdNode *f, DdNode *g));
...
EXTERN DdNode * Cudd_AddMakeVarMaskRecur ARGS((DdManager *dd, DdNode * N, int n, int l, int offset));
/* NuSMV: added end */
/* NuSMV: removed begin */
