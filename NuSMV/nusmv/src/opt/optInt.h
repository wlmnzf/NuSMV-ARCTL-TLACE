/**CHeaderFile*****************************************************************
  ...
  Revision    [$Id: optInt.h,v 1.5.4.6.2.2 2004/07/28 14:03:50 nusmv Exp $]
...
/* 29/04/10 sbusard */
char * tlaces_output_file;
#define TLACES_OUTPUT_FILE "output_tlaces_file"
int tlaces_explain_level;
#define TLACES_EXPLAIN_LEVEL     "tlaces_explain_level"

/* 01/07/11 sbusard */
int tlaces_depth;
#define TLACES_DEPTH	"tlaces_depth"
