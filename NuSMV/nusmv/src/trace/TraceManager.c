...
static char rcsid[] UTIL_UNUSED = "$Id: TraceManager.c,v 1.1.2.29 2004/05/31 13:58:13 nusmv Exp $";
...
/**Function********************************************************************
  ...
  Synopsis    [Returns the number of plugins registered with TraceManager.]

  Description [This function returns the number of plugins registered with
  traceManager]
                                ...
                                int trace_index)
{
  ...
  default:   /* Requested plugin is not loaded */
