/**CHeaderFile*****************************************************************
  ...
  Revision    [$Id: compile.h,v 1.44.4.17 2004/05/27 13:06:06 nusmv Exp $]
...
EXTERN NodeList_ptr
Compile_get_expression_dependencies_ExeptForSimpleExpr ARGS((const Encoding_ptr, Expr_ptr));
...
//TODO ADD COMMENTS
// JVANDERM's CHANGE (2007-08-24)
EXTERN Set_t Formula_GetDependencies_ExeptForSimpleExpr ARGS((const Encoding_ptr senc,
				node_ptr, node_ptr));
