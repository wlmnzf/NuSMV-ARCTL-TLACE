/**CHeaderFile*****************************************************************
  ...
  Revision    [$Id: mcInt.h,v 1.3.6.13 2004/04/15 11:22:46 nusmv Exp $]
...
/* sbusard 25/11/11 */
EXTERN node_ptr reachable_explain ARGS((BddFsm_ptr fsm, BddEnc_ptr enc, node_ptr path, bdd_ptr act));

EXTERN node_ptr eau_explain ARGS((BddFsm_ptr fsm, BddEnc_ptr enc, node_ptr path, bdd_ptr f, bdd_ptr g, bdd_ptr si));
EXTERN node_ptr eax_explain ARGS((BddFsm_ptr fsm, BddEnc_ptr enc, node_ptr path, bdd_ptr f, bdd_ptr si));
EXTERN node_ptr eag_explain ARGS((BddFsm_ptr fsm, BddEnc_ptr enc, node_ptr witness_path, bdd_ptr g, bdd_ptr si));
