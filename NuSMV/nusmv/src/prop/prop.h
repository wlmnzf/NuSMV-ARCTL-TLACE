/**CHeaderFile*****************************************************************
  ...
  Revision    [$Id: prop.h,v 1.14.2.6 2004/05/19 14:36:01 nusmv Exp $]
...
/* Property database. RC: property db should be a real DTD */
EXTERN void PropDb_create ARGS((void));
EXTERN void PropDb_destroy ARGS((void));

EXTERN int  
PropDb_fill ARGS((Encoding_ptr senc, node_ptr, node_ptr, node_ptr, node_ptr));
...
EXTERN void PropDb_print_all_status_type ARGS((FILE* file, 
