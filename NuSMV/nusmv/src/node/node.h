...
/* 30/04/10 sbusard */
EXTERN int      print_node_XML ARGS((FILE *, node_ptr));
EXTERN int      print_node_custom_XML ARGS((FILE *, node_ptr, custom_print_node_t));
EXTERN char *   sprint_node_XML ARGS((node_ptr));
