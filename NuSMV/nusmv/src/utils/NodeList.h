/**CHeaderFile*****************************************************************
  ...
  Revision    [$Id: NodeList.h,v 1.1.2.6 2004/02/06 15:01:41 nusmv Exp $]
...
EXTERN int 
NodeList_count_element ARGS((const NodeList_ptr self, node_ptr elem));

EXTERN ListIter_ptr NodeList_get_first_iter ARGS((const NodeList_ptr self));

EXTERN node_ptr NodeList_get_value_at ARGS((const NodeList_ptr self, 
