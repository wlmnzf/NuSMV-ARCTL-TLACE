...
static char rcsid[] UTIL_UNUSED = "$Id: utils.c,v 1.1.4.6.2.2 2004/06/21 12:32:25 nusmv Exp $";
...
#   endif /* __MINGW32__ */
  ...
  snprintf(name, len-1, "%s%c%s", dirname, dir_separator, templ);
  FREE(dirname);
