...
define(`TAX',`AAX(RUN)($1)')
define(`TAF',`AAF(RUN)($1)')
define(`TAG',`AAG(RUN)($1)')
define(`TAU',`AA(RUN)[$1 U $2]')
define(`TEX',`EAX(RUN)($1)')
define(`TEF',`EAF(RUN)($1)')
define(`TEG',`EAG(RUN)($1)')
define(`TEU',`EA(RUN)[$1 U $2]')
